...
function celebrityIDCreator (theCelebrities) {
	...
	for (i = 0; i < theCelebrities.length; i++) {
		theCelebrities[i]["id"] = function (j)  { 
			...
			// IIFE means Immediately Invoked Function Expresion

			return function () {

				return uniqueID + j; 
				// each iteration of the for loop passes the current value of 
				// i into this IIFE and it saves the correct value to the array​

			} () 
			// BY adding () at the end of this function, we are executing
			// it immediately and returning just the value of uniqueID + j, 
